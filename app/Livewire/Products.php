...
class Products extends Component
{
    ...
    public $search, $editing, $tab = 1, $categories, $suppliers, $btnCreateCategory = false, $btnCreateSupplier = false, $catalogueName, $pagination = 25;
    ...
    public function render()
    {
        ...
        return view('livewire.products.products', [
            'products' => Ct_Product::paginate($this->pagination)
        ]);
    }
    ...
    function getProducts()
    {
        ...
        try {
            if (!empty($this->search)) {
                $this->resetPage();
                $products = Ct_Product::search(trim($this->search))->orderBy('id')->paginate($this->pagination);
                return $products;
            } else {
                $products = Ct_Product::all()->paginate($this->pagination);
                dd($products, "ok");
                return $products;
            }
        } catch (\Exception $th) {
