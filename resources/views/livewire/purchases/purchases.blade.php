<div>
    <div class="row">
        ...
        @if ($showReceiveView)
            <div class="col-sm-4">
                <button class="btn-success" wire:click="resetView">← Return</button>
            </div>
            <div class="col-sm-4">
            ...
            @livewire('purchase-order-receive', ['poId' => $selectedPoId])
        @else
            <div class="col-sm-12 col-md-12">
                ...
                <table id="pending_purchases" class="table table-hover table-condensed table-striped table-bordered mytables" style="font-size:98%">
                    ...
                    <tbody>
                        ...
                        <td>{{$po->ShipToName}}</td>
                        <td>
                            <button wire:click="showReceive({{ $po->id }})" class="btn btn-primary btn-sm">
