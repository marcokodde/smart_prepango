                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        ...
                                        <small class="text-info">sku:{{$product->item_code}}</small>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        $10
                                    </td>
                                    <td class="text-center">{{$product->e911 == 1 ? 'SERVICIO' : 'PRODUCTO'}}
                                    </td>
                                    <td class="text-center">{{$product->product_status_id == 1 ? 'DISPONIBLE' : 'NO DISPONIBLES' }}</td>
                                    <td class="text-center">
                                        <div>
                                            <span
                                                class="badge {{$product->target_inventory > $product->safety_stock ? 'badge-light-success':'badge-light-danger' }} ">Stock:{{$product->target_inventory}}</span>
                                        </div>
                                        <small>Mínimo:{{$product->safety_stock}}</small>
                                    </td>
